...
### Fixed
- Update .gitignore: ignore terminal sessions


## [0.8.1] - 2026-03-25

### Fixed
- feat: complete preset coverage for all components and sections — v0.8.0
...
[0.8.1]: https://github.com/Agile-Media-Agency/the-fluid-theme/compare/v0.8.0...v0.8.1
[0.8.2]: https://github.com/Agile-Media-Agency/the-fluid-theme/compare/v0.8.1...v0.8.2
