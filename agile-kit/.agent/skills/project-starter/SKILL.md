...
For each included flow, document the sequence — even if it's simple:
...
These templates exist in the Fluid Theme repo and can be used as starting points:
...
2. Set up the routing / navigation to match
