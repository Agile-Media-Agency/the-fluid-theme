...
> **Version:** 0.3.5
>
> **⚠ Version check:** This skill was verified against v0.3.5. Before using, check the repo's `PROJECT_STATUS.md` for the current version. If it differs, component APIs, token names, or available templates may have changed. Update this skill accordingly.
...
See `ux-behavior-spec` skill §18 for the full gap tracker. Remaining gaps: action group (responsive overflow), mobile sticky CTA bar, cookie consent banner. Most previously tracked gaps have been resolved in v0.3.5.
